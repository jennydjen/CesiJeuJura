...
public class ListeDevisBureauEtudes extends VerticalLayout {
	...
	public ListeDevisBureauEtudes(DevisIEJB devisEJB, Type_PieceIEJB typePieceEJB, PieceIEJB pieceEJB) {
 		Design.read(this);
		...
		btnOuvrir.addClickListener(new Button.ClickListener() {
			...
			public void buttonClick(ClickEvent event) {
				...
				if(selectDevis != null){
					removeAllComponents();
					addComponent(new FicheDevis(devisEJB, selectDevis.getId(), typePieceEJB, pieceEJB));
				}else{
