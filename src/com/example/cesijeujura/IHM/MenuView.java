...
public class MenuView extends VerticalLayout {
	...
	public MenuView(final DevisIEJB devisEJB, final ClientIEJB clientEJB, final ModuleIEJB moduleEJB, final UserIEJB userEJB , final ComposantIEJB composantEJB
		...
		MenuBar.Command deconnectionMenu = new Command() {
			
			@Override
			public void menuSelected(MenuItem selectedItem) {
				CesijeujuraUI.getInstance().afficherLoginView();
				Notification.show("Vous êtes déconnecté", Type.TRAY_NOTIFICATION);
			}
		};
		...
		menuBar.addItem("Déconnexion", deconnectionMenu);
	}
