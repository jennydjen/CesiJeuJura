...
public class FicheClient extends VerticalLayout {
	...
	public FicheClient(final DevisIEJB devisEJB, final Client client) {
		...
		seeDevisButton.addClickListener(new Button.ClickListener() {
			...
			public void buttonClick(ClickEvent event) {
				...
				CesijeujuraUI.getInstanceMenuView().afficherFicheDevis(
						p.getDevis().get(p.getDevis().size() - 1).getId());
			}
		});
		...
		projectTable.addContainerProperty("Etat de la commande", Etat.class,
				Etat.A_TRAITER);
		...
		buttonCreateProject.addClickListener(new Button.ClickListener() {
			...
			@Override
			public void buttonClick(ClickEvent event) {
				devisEJB.initialiseDevisTMP(client, CesijeujuraUI.getInstance()
						.getUser());
